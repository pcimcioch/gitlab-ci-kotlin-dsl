...
@GitlabCiDslMarker
class ImageDsl : DslBase {
    var name: String? = null
    private var entrypoint: List<String> = listOf()

    // TODO all Dsl objects with constructors with default parameters?
    constructor()
    ...
    override fun validate(errors: MutableList<String>) = addError(errors, isEmpty(name), "[image] name '$name' is incorrect")
}
